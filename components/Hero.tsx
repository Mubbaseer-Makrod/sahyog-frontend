        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="inline-flex items-center gap-2 bg-green-100 border border-green-300 rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-green-800 text-sm font-semibold">Trusted by 1000+ Farmers</span>
            </div>

            {/* Main Heading */}
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-gray-900 mb-4 leading-tight">
              Quality Tractors for{" "}
            ...
            <p className="text-base sm:text-lg text-gray-600 mb-8 leading-relaxed max-w-xl mx-auto lg:mx-0">
              Empowering farmers with reliable machinery and exceptional service. 
              Find the perfect tractor for your agricultural needs.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <a
                href="#products"
                className="group bg-green-600 text-white px-8 py-4 rounded-xl font-bold text-base hover:bg-green-700 transform hover:scale-105 transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
              >
                <span>Browse Tractors</span>
            ...
            <div className="mt-10 grid grid-cols-3 gap-4 pt-8 border-t border-gray-200 max-w-md mx-auto lg:mx-0">
              <div className="text-center lg:text-left">
                ...
                <div className="text-xs text-gray-600">Tractors Sold</div>
              </div>
              <div className="text-center lg:text-left">
