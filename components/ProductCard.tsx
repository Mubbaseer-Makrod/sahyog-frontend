  ...
  return (
    <>
      <div className="relative bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-200 hover:border-green-300 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 h-full min-h-[400px] group">
        {/* Image Carousel */}
        <div 
          className="absolute inset-0 w-full h-full overflow-hidden bg-gradient-to-br from-green-50 to-emerald-50 cursor-pointer"
        ...
        {/* Content */}
        <div className="absolute bottom-0 left-0 right-0 p-4 pb-14 space-y-2 z-10 pointer-events-none">
          {/* Title with accent */}
